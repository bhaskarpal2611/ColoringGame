...
namespace DrawingGame
{
    public class LevelSelectionManager : MonoBehaviour
    {
        ...
        [Tooltip("Empty GameObject assigned as IdleTutorialLoop._allowedWhenActive. Enable = game scene active, Disable = selection screen active.")]
        [SerializeField] private GameObject _idleTutorialGate;
        ...
        public void LoadDrawingScene(int index = -1)
        {
            ...
            if (_idleTutorialGate != null) _idleTutorialGate.SetActive(true);
...
// #endif
        ...
        private IEnumerator SaveTextures()
        {
            ...
            _loadingPanel.DOScale(0f, 0.25f)
                ...
                .OnComplete(() =>
                {
                    ...
                    if (_idleTutorialGate != null) _idleTutorialGate.SetActive(false);
                    _paintService.OnBackButtonPressed();
                    GenericTutorialManager.Instance?.HideImmediately();
        ...
        private IEnumerator SaveDrawing()
        {
            ...
            _loadingPanel.DOScale(0f, 0.25f).SetEase(Ease.Linear).OnComplete(() =>
            {
                ...
                _selectionSceneCanvas.SetActive(true);
                _idleTutorialGate.SetActive(false);
