...
namespace ColorSwipeGame
{
    ...
    public class TutorialHandBounce : MonoBehaviour
    {
        ...
        private void Update()
        {
            bool isTap = _tutorialManager != null && (_tutorialManager.CurrentInputType == TutorialInputType.Tap || _tutorialManager.CurrentInputType == TutorialInputType.TapTarget);
            if (!isTap)
            {
                transform.localScale = _baseScale;
                return;
